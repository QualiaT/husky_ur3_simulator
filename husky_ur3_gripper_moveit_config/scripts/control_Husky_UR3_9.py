...
if __name__=='__main__':
    ...
    ar_pose = Pose()
    ar_pose.position.x = ar_tr[0]
    ar_pose.position.y = ar_tr[1]
    ar_pose.position.z = ar_tr[2]
...
#
    #    eef_x = eef_poses.position.x
    #    eef_y = eef_poses.position.y
#
    #    x_offset = ar_pose.position.x - eef_x
    #    y_offset = ar_pose.position.y - eef_y
#
    #    if x_offset > 0 :
    #        speed.linear.x = 0.1
    #        speed.angular.z  = 0
    ...
    #    
#
    #    jmove_to_pose_goal(ar_pose) #down pose 
    #    print ar_tr[0],ar_tr[1]
    #    print x_offset,y_offset
#
    #    pub.publish(speed)

    #목표eef의 방향과 모바일플랫폼의 방향을 일치할 때까지 모바일 플랫폼을 회전.
    #while abs(theta-angle_to_goal) > 0.1:
    #    speed.angular.z = 0.1
    #    speed.angular.x = 0.0
#
    #    pub.publish(speed)
